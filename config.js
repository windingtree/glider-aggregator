    ...
    Participants: {
      Participant: {
        EnabledSystemParticipant: {
          ...
          Name: getConfigKey('AC_PARTICIPANT_ENABLED_SYSTEM_PARTICIPANT_NAME'),
          ...
          SystemID: {
            ...
            '@value': getConfigKey('AC_PARTICIPANT_ENABLED_SYSTEM_PARTICIPANT_SYSTEM_ID'),
          }
        }
      }
    }
...
module.exports.redisUrl = getConfigKey('REDIS_URL');
module.exports.mongoUrl = getConfigKey('MONGO_URL');
module.exports.elasticUrl = getConfigKey('ELASTIC_URL');
...
module.exports.JWT = getConfigKey('JWT');
