...
const fulfillOrderTransformTemplate_AF = {
  travelDocuments: {
    bookings: ['/S:Envelope/S:Body/ns2:OrderViewRS/ns2:Response/ns2:Order/ns2:BookingReferences/ns2:BookingReference','ns2:ID'],
    etickets: ['/S:Envelope/S:Body/ns2:OrderViewRS/ns2:Response/ns2:TicketDocInfos/ns2:TicketDocInfo', {
