...
const hotelAvailTransformTemplate = {
  acomodation: ['/soap:Envelope/soap:Body/OTA_HotelAvailRS/HotelStays/HotelStay', {
    ...
    contactInformation: {
      phoneNumbers: ['BasicPropertyInfo/ContactNumbers/ContactNumber', '@PhoneNumber'],
      emails: ['BasicPropertyInfo/Address/TPA_Extensions/Emails/Email', '@email_ID']
    },
    checkinoutPolicy: {
      checkinTime: 'BasicPropertyInfo/Policy/@CheckInTime',
      checkoutTime: 'BasicPropertyInfo/Policy/@CheckOutTime',
    },
    otherPolicies: ['BasicPropertyInfo/Address/TPA_Extensions/Policies/policy', {
      _id_: '@Policy_Type',
      _value_: '@Text',
    }],
    media: [ 'BasicPropertyInfo/Address/TPA_Extensions/photos/photo', {
      type: '#photo',
      width: '@width',
      height: '@height',
      url: '@url',      
...
const errorsTransformTemplate = {
  errors: ['soap:Envelope/soap:Body/OTA_HotelAvailRS/Errors/Error', {
    message: '@ShortText',
    code: '@Code',
  }]
};
