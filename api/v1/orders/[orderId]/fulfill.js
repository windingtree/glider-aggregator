...
module.exports = basicDecorator(async (req, res) => {
  ...
  const guaranteeResponse = await axios.get(
    `https://staging.simard.windingtree.net/api/v1/balances/guarantees/${body.guaranteeId}`,
    {
  ...
  const guarantreeClaim = await axios.post(
    `https://staging.simard.windingtree.net/api/v1/balances/guarantees/${body.guaranteeId}/claim`,
    {},
    {
      headers: simardHeaders,
    }
